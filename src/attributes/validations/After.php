...
/**
 * Validates that input is a date strictly after a fixed date (or 'now').
 */
class After extends RequestAttribute
{
    ...
    /**
     * Checks whether the input parses to a timestamp later than the configured date.
     */
